...
// téléverser fichiers avec le bouton
...
// téléversement du fichier dans la base de données
function uploadFile(file){
    ...
    http.open('POST', 'senderCloud.php', true)
    http.send(data)
    li.querySelector('.cross').onclick = () => http.abort()
    http.onabort = () => li.remove()
}

// afficher la bonne icône pour le fichier téléversé
